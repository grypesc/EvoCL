...
class Inc_Learning_Appr:
    ...
    def _get_optimizer(self):
        ...
        return torch.optim.SGD(self.model.parameters(), lr=self.lr, weight_decay=self.wd, momentum=0.9)
    ...
    def train_loop(self, t, trn_loader, val_loader):
        ...
        lr_scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer=self.optimizer, milestones=[int(self.nepochs * 0.4), int(self.nepochs * 0.8)], gamma=0.1)
