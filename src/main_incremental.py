...
def main(argv=None):
    tstart = time.time()
    # Arguments
    parser = argparse.ArgumentParser(description='FACIL - Framework for Analysis of Class Incremental Learning', allow_abbrev=False)
    ...
    parser.add_argument('--s', default=32, type=int, required=False,
    ...
    if args.network in tvmodels:  # torchvision models
        ...
        init_model = net(args.s, pretrained=False)
